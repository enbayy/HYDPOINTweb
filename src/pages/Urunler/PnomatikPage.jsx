            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 flex-1">
                {PnomatikData.map((card) => (
                    <div
                        ...
                        className="cursor-pointer bg-white dark:bg-zinc-900 rounded-2xl shadow-lg overflow-hidden transition-transform transform hover:scale-105 hover:shadow-xl duration-300"
                    >
