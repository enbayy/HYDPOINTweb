...
const CTASection = () => {
  ...
  return (
    <section
      ...
      className="relative text-center py-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-black via-gray-900 to-black">
      <div className="absolute inset-0 opacity-25 bg-gradient-to-tr from-orange-500 via-pink-500 to-purple-600 mix-blend-multiply pointer-events-none rounded-lg">
      </div>
